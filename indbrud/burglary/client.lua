...
sstimerstart11 = timer10 + 0
if terstart11 > 60 then 
	print('more than 60 min 1')
	terstart11 = terstart11 - 60
	sstimerstart11 = sstimerstart11 +1
end
callonetime111 = true
end
ternu11 = minutter10 + 0
ternu111 = skunder10 + 0
ssstimerstart11 = timer10 + 0
 left = TimeToSeconds(sstimerstart11,terstart11,terstart111) - TimeToSeconds(ssstimerstart11,ternu11,ternu111)
